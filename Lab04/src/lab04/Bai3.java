...
public class Bai3 extends JFrame {
    ...
    public void addControl(){
        ...
        TitledBorder centerTitleBorder= new
        TitledBorder(centerborder, "nhập 2 số a và b:");
        ...
        btnGiai.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                if(radCong.isSelected()==false && radTru.isSelected()==false
                        && radNhan.isSelected()==false && radChia.isSelected()==false){
                    JOptionPane.showMessageDialog(null,"Vui lòng chọn phép tính!");
                }
                txtkq.setText(kq+"");
            }
        });
